              ...
              {orders.map((order) => {
                ...
                return (
                  <tr key={order.id}>
                    ...
                    <td>
                      <span className={`badge ${statusInfo.className} d-inline-flex align-items-center gap-1 text-xs`}>
                        <StatusIcon size={12} />
                    ...
                    {canChangeStatus && (
                      <td>
                        ...
                        >
                          ...
                          <option value={ORDER_STATUS.PREPARANDO}>Preparando</option>
